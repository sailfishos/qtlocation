...
class tst_QPlaceManagerHere : public QObject
{
    Q_OBJECT
public:
...
bool tst_QPlaceManagerHere::checkSignals(QPlaceReply *reply, QPlaceReply::Error expectedError)
{
...
#include "tst_qplacemanager_here.moc"
