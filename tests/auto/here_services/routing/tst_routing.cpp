...
class tst_here_routing : public QObject
{
    Q_OBJECT
...
tst_here_routing::tst_here_routing()
...
void tst_here_routing::loadReply(const QString& filename)
{
...
void tst_here_routing::calculateRoute()
{
...
void tst_here_routing::onReply(QGeoRouteReply* reply)
{
    QVERIFY(reply);
    //QVERIFY(0 == m_reply);
    m_reply = reply;
...
void tst_here_routing::verifySaneRoute(const QGeoRoute& route)
{
...
void tst_here_routing::routingFinished(QGeoRouteReply* reply)
{
    onReply(reply);
}

void tst_here_routing::routingError(QGeoRouteReply* reply, QGeoRouteReply::Error error, QString errorString)
{
    Q_UNUSED(error);
...
void tst_here_routing::initTestCase()
{
...
void tst_here_routing::cleanupTestCase()
{
...
void tst_here_routing::can_compute_route_for_all_supported_travel_modes()
{
...
void tst_here_routing::can_compute_route_for_all_supported_travel_modes_data()
{
...
void tst_here_routing::can_compute_route_for_all_supported_optimizations()
{
...
void tst_here_routing::can_compute_route_for_all_supported_optimizations_data()
{
...
void tst_here_routing::can_handle_multiple_routes_in_response()
{
...
void tst_here_routing::can_handle_no_route_exists_case()
{
...
void tst_here_routing::can_handle_additions_to_routing_xml()
{
...
void tst_here_routing::can_handle_invalid_server_responses()
{
    QFETCH(QString, file);
...
void tst_here_routing::can_handle_invalid_server_responses_data()
{
    QTest::addColumn<QString>("file");
...
void tst_here_routing::foobar_data()
{
...
QTEST_APPLESS_MAIN(tst_here_routing)
