...
class tst_QPlaceManagerHere : public PlaceManagerUtils
{
    Q_OBJECT
public:
...
private:
    ...
    static const QLatin1String AppCodeEnv;

    QGeoServiceProvider *provider;
};

Q_DECLARE_METATYPE(tst_QPlaceManagerHere::ExpectedResults)
...
const QLatin1String tst_QPlaceManagerHere::AuvergneEmbassyId("250u09tv-be16478e55314b338c551aab2651c9d3");

const QLatin1String tst_QPlaceManagerHere::ProxyEnv("HERE_PLUGIN_PROXY");
const QLatin1String tst_QPlaceManagerHere::AppIdEnv("HERE_APP_ID");
const QLatin1String tst_QPlaceManagerHere::AppCodeEnv("HERE_APP_CODE");

tst_QPlaceManagerHere::tst_QPlaceManagerHere()
{
}

void tst_QPlaceManagerHere::initTestCase()
{
    QVariantMap params;
    ...
    if (!(env.contains(AppIdEnv) && env.contains(AppCodeEnv)))
        QSKIP("HERE_APP_ID and HERE_APP_CODE environment variables not set");\

    params.insert(QStringLiteral("app_id"), env.value(AppIdEnv));
    params.insert(QStringLiteral("app_code"), env.value(AppCodeEnv));

    if (env.contains(ProxyEnv))
        params.insert(QStringLiteral("proxy"), env.value(ProxyEnv));
#else
    QSKIP("Cannot parse process environment, HERE_APP_ID and HERE_APP_CODE not set");
#endif
...
void tst_QPlaceManagerHere::search()
{
...
void tst_QPlaceManagerHere::search_data()
{
...
void tst_QPlaceManagerHere::searchResultFields()
{
...
void tst_QPlaceManagerHere::recommendations()
{
...
void tst_QPlaceManagerHere::recommendations_data()
{
...
void tst_QPlaceManagerHere::details()
{
...
void tst_QPlaceManagerHere::categories()
{
...
void tst_QPlaceManagerHere::suggestions()
{
    QFETCH(QGeoShape, area);
    QFETCH(QString, searchTerm);
    QFETCH(QPlaceReply::Error, error);
...
void tst_QPlaceManagerHere::suggestions_data()
{
    QTest::addColumn<QGeoShape>("area");
    QTest::addColumn<QString>("searchTerm");
    QTest::addColumn<QPlaceReply::Error> ("error");
...
void tst_QPlaceManagerHere::suggestionsMisc()
{
...
void tst_QPlaceManagerHere::locale()
{
...
void tst_QPlaceManagerHere::content()
{
...
void tst_QPlaceManagerHere::content_data()
{
...
void tst_QPlaceManagerHere::unsupportedFunctions()
{
    QPlace place;
...
void tst_QPlaceManagerHere::commonAreas(QList<QByteArray> *dataTags,
                                          QList<QGeoShape> *areas,
                                          QList<QPlaceReply::Error> *errors,
                                          QList<ExpectedResults> *results)
{
...
QTEST_GUILESS_MAIN(tst_QPlaceManagerHere)
