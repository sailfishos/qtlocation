...
#ifndef QGEOTILEDMAPPINGMANAGERENGINE_HERE_H
#define QGEOTILEDMAPPINGMANAGERENGINE_HERE_H

#include "maptiles/qgeomapversion.h"
...
class QGeoTiledMappingManagerEngineHere : public QGeoTiledMappingManagerEngine
{
    Q_OBJECT

public:
    QGeoTiledMappingManagerEngineHere(QGeoNetworkAccessManager *networkManager,
                                       const QMap<QString, QVariant> &parameters,
                                       QGeoServiceProvider::Error *error,
                                       QString *errorString);
    ~QGeoTiledMappingManagerEngineHere();
...
#endif // QGEOTILEDMAPPINGMANAGERENGINE_HERE_H
