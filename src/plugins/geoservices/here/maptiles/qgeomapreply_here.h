...
#ifndef QGEOMAPREPLY_HERE_H
#define QGEOMAPREPLY_HERE_H
...
class QGeoMapReplyHere : public QGeoTiledMapReply
{
    Q_OBJECT

public:
    QGeoMapReplyHere(QNetworkReply *reply, const QGeoTileSpec &spec, QObject *parent = 0);
    ~QGeoMapReplyHere();
