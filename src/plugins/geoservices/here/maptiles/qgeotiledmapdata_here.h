...
#ifndef QGEOMAPDATA_HERE_H
#define QGEOMAPDATA_HERE_H
...
class QGeoTiledMapDataHere: public QGeoTiledMapData
{
Q_OBJECT
public:
    QGeoTiledMapDataHere(QGeoTiledMappingManagerEngineHere *engine, QObject *parent = 0);
    ~QGeoTiledMapDataHere();
...
private:
    Q_DISABLE_COPY(QGeoTiledMapDataHere)
