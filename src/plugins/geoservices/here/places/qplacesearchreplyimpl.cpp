...
#include "places/jsonparserhelpers.h"
...
QPlaceSearchReplyImpl::QPlaceSearchReplyImpl(const QPlaceSearchRequest &request,
                                             QNetworkReply *reply,
                                             QPlaceManagerEngineHere *parent)
...
void QPlaceSearchReplyImpl::replyFinished()
{
    if (m_reply->error() != QNetworkReply::NoError) {
        ...
        case QNetworkReply::OperationCanceledError:
            setError(CancelError, QCoreApplication::translate(HERE_PLUGIN_CONTEXT_NAME, CANCEL_ERROR));
            break;
        case QNetworkReply::ContentNotFoundError:
            ...
            break;
        default:
            setError(CommunicationError, QCoreApplication::translate(HERE_PLUGIN_CONTEXT_NAME, NETWORK_ERROR));
        }
        return;
    }
    ...
    if (!document.isObject()) {
        setError(ParseError, QCoreApplication::translate(HERE_PLUGIN_CONTEXT_NAME, PARSE_ERROR));
        return;
    }
