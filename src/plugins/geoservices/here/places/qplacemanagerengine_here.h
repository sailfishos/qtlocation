...
#ifndef QPLACEMANAGERENGINE_HERE_H
#define QPLACEMANAGERENGINE_HERE_H
...
class QPlaceManagerEngineHere : public QPlaceManagerEngine
{
    Q_OBJECT

public:
    QPlaceManagerEngineHere(QGeoNetworkAccessManager *networkManager,
                            const QMap<QString, QVariant> &parameters,
                            QGeoServiceProvider::Error *error,
                            QString *errorString);
    ~QPlaceManagerEngineHere();
...
#endif // QPLACEMANAGERENGINE_HERE_H
