...
QGeoIntrinsicNetworkAccessManager::QGeoIntrinsicNetworkAccessManager(const QMap<QString, QVariant> &parameters, const QString &proxyToken, QObject *parent)
    : QGeoNetworkAccessManager(parent)
    , m_customProxyToken(proxyToken)
    , m_networkManager(new QNetworkAccessManager(this))
{
