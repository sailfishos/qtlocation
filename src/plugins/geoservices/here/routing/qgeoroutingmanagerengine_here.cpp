...
#include "routing/qgeoroutereply_here.h"
...
QGeoRoutingManagerEngineHere::QGeoRoutingManagerEngineHere(
...

{
    ...
    m_appCode = parameters.value(QStringLiteral("app_code")).toString();
...
QGeoRouteReply *QGeoRoutingManagerEngineHere::calculateRoute(const QGeoRouteRequest &request)
{
    ...
    QGeoRouteReplyHere *reply = new QGeoRouteReplyHere(request, replies, this);
...
QGeoRouteReply *QGeoRoutingManagerEngineHere::updateRoute(const QGeoRoute &route, const QGeoCoordinate &position)
{
    ...
    QGeoRouteReplyHere *reply = new QGeoRouteReplyHere(updateRequest, replies, this);
...
bool QGeoRoutingManagerEngineHere::checkEngineSupport(const QGeoRouteRequest &request,
...
QStringList QGeoRoutingManagerEngineHere::calculateRouteRequestString(const QGeoRouteRequest &request)
{
    ...
    if (!m_appId.isEmpty() && !m_appCode.isEmpty()) {
        baseRequest += QStringLiteral("&app_id=");
        baseRequest += m_appId;
        baseRequest += QStringLiteral("&app_code=");
        baseRequest += m_appCode;
    }
...
QStringList QGeoRoutingManagerEngineHere::updateRouteRequestString(const QGeoRoute &route, const QGeoCoordinate &position)
{
...
QString QGeoRoutingManagerEngineHere::modesRequestString(const QGeoRouteRequest &request,
...
QString QGeoRoutingManagerEngineHere::routeRequestString(const QGeoRouteRequest &request) const
{
    QString requestString;
...
QString QGeoRoutingManagerEngineHere::trimDouble(double degree, int decimalDigits)
{
...
void QGeoRoutingManagerEngineHere::routeFinished()
{
...
void QGeoRoutingManagerEngineHere::routeError(QGeoRouteReply::Error error, const QString &errorString)
{
    QGeoRouteReply *reply = qobject_cast<QGeoRouteReply *>(sender());
